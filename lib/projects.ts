...
export const projects: Project[] = [
  {
    slug: 'masonry-demo',
    name: 'Masonry / Construction Website',
    status: 'CLIENT',
    kind: 'build',
    summary: 'A service-business website concept focused on trust, service clarity and straightforward enquiries.',
    problem: 'Service businesses often lose enquiries when their offer, proof and next step are difficult to understand.',
    build: 'A focused masonry and construction experience with clear services, trust signals and enquiry-focused structure.',
    value: 'A clearer path from local search or referral traffic to a qualified enquiry.',
    stack: ['HTML', 'CSS', 'JavaScript'],
    github: 'https://github.com/pateljiop/Demo',
    demo: 'https://pateljiop.github.io/Demo/',
  },
  {
    slug: 'laundry-demo',
    name: 'Laundry Service Website',
    status: 'CLIENT',
    kind: 'build',
    summary: 'A local-service concept designed to make the offer easy to understand and the next action easy to find.',
    ...
    demo: 'https://pateljiop.github.io/Laundry-demo/',
  },
  {
    slug: 'roofing-demo',
    ...
    status: 'CLIENT',
    kind: 'build',
    summary: 'A roofing-business concept built around credibility, service clarity and high-intent enquiries.',
    ...
    demo: 'https://pateljiop.github.io/Roofing-demo/',
  },
  {
    slug: 'mek-property-maintenance',
    name: 'Property Maintenance Website',
    status: 'CLIENT',
    kind: 'build',
    summary: 'A property-maintenance concept showing a practical service experience built for trust and enquiries.',
    problem: 'Property maintenance services need clear offers, proof and a low-friction route to contact.',
    ...
    demo: 'https://pateljiop.github.io/mek-property-maintenance-demo/',
  },
  {
